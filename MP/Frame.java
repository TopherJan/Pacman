...
public class Frame extends JFrame {
  ...
  protected ChangeBackgroundPanel background;
  protected ChangeBackgroundPanel background2;
  protected ChangeBackgroundPanel background3;
  protected ChangeBackgroundPanel background4;
  protected ChangeBackgroundPanel background5;
  protected ChangeBackgroundPanel background6;
  protected ChangeBackgroundPanel background7;
  protected ChangeBackgroundPanel background8;
  protected ChangeBackgroundPanel background9;
  ...
  public void backToMenu(){
	...
	backButton.addActionListener(new ActionListener(){
		public void actionPerformed(ActionEvent event){
			clickClip.start();
			if(background == background4 || background == background5 || background == background6)
			displayMenu();

			if(background == background7)
			displayInstructions();
		}
	});

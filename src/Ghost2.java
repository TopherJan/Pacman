...
public class Ghost2 {
  ...
  static String ghostName = "images/ghostSprite/greenghost.png";
	...
	for(int i = 0; i < 61; i++){
      if(tilex == xTile[i]*30 && tiley == yTile[i]*30){
        ...
        if(tilex < 30){
          ...
          if(l == 1){
            //System.out.println("LEFT IS AVAILABLE");
          }
          if(r == 1){
            //System.out.println("RIGHT IS AVAILABLE");
          }
          if(u == 1){
            //System.out.println("UP IS AVAILABLE");
          }
          if(d == 1){
            //System.out.println("DOWN IS AVAILABLE");
          }
  ...
  public void moveUp(){
	if(imageBool)
	ghostName = "images/ghostSprite/upGREEN.png";
  ...
  public void moveDown(){
	if(imageBool)
	ghostName = "images/ghostSprite/downGREEN.png";
  ...
  public void moveRight(){
	if(imageBool)
	ghostName = "images/ghostSprite/rightGREEN.png";
  ...
  public void moveLeft(){
	if(imageBool)
	ghostName = "images/ghostSprite/leftGREEN.png";
